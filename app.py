...
st.sidebar.download_button("マスタDL", create_master_template(), "master.xlsx")
st.sidebar.download_button("チェックDL", create_check_template(), "check.xlsx")
st.sidebar.download_button("マニュアルDL", create_manual_pdf(), "manual.pdf")
